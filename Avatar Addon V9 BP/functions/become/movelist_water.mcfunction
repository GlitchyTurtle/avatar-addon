...
tellraw @s[scores={level=20..}] {"rawtext":[{"text":"§bSlot 5 §r- Look down and jump to trigger whatever move you have for slot 5."}]}
tellraw @s[scores={level=30..}] {"rawtext":[{"text":"§bSlot 6 §r- Jump and sneak to trigger whatever move you have for slot 6."}]}
tellraw @s {"rawtext":[{"text":"-----------------------------------------§r"}]}
...
tellraw @s[scores={level=10..}] {"rawtext":[{"text":"§bWater Blade Boost [Combo] §r-  Boost yourself away from danger and do damage. Punch use the next combo piece."}]}
tellraw @s {"rawtext":[{"text":"-----------------------------------------§r"}]}
