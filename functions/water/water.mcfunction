...
#Passives
execute @s[tag=water,tag=!antimagic] ~ ~ ~ detect ~ ~ ~ water 0 effect @s strength 1 1 true
execute @s[tag=water,tag=!antimagic] ~ ~ ~ detect ~ ~-1 ~ water 0 effect @s strength 1 1 true
execute @s[tag=water,tag=!antimagic] ~ ~ ~ detect ~ ~1 ~ water 0 effect @s strength 1 1 true
