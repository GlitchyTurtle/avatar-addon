...
execute @s[tag=chooseslot4,scores={chooseslot=45..}] ~ ~ ~ scoreboard players set @s chooseslot 1
execute @s[scores={detect_sneak=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§3You chose the move for slot 1!"}]}
 
execute @s[tag=chooseslot4,scores={chooseslot=0..45,detect_sneak=1}] ~ ~ ~ scoreboard players operation @s moveslot1 = @s chooseslot
