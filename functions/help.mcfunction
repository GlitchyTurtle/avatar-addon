...
tellraw @s {"rawtext":[{"text":"§b/function stats §r- stats - shows your current level and progress to the next one."}]}
tellraw @s {"rawtext":[{"text":"§b/function toggle_bending §r- disable bending - turn your bending on and off, same as putting arrows in your offhand."}]}
tellraw @s {"rawtext":[{"text":"-----------------------------------------§r"}]}
