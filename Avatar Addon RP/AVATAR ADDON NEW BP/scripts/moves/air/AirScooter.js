...
import { getScore, setScore, calcVectorOffset, delayedFunc } from "../../util.js";
    ...
    execute(player) {
        ...
        delayedFunc(player, (airRush) => {
            ...
            const sched_ID = system.runInterval(function tick() {
                ...
                if (getScore("sneak_time", player) > 0 || getScore("cooldown", player) < 40) return system.clearRun(sched_ID);
            }, 1);
        }, 1);
    }
}
