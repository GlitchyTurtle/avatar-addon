    ...
    execute(player, decay) {
        ...
        delayedFunc(player, (airTornado) => {
            ...
            const sched_ID = system.runInterval(function tick() {
                ...
                // Spawn the particle
                for (let i = 1; i < 15; i++) {
                    map.setVector3("variable.plane", { x: 0.3 / decay, y: 15 / decay, z: 2 * i / decay });
                    player.dimension.spawnParticle("a:air_shockwave_dynamic", {x: currentPos.x, y: currentPos.y + i/3, z: currentPos.z}, map);
