...
import { setScore, getScore, calcVectorOffset, delayedFunc, playSound, calcBendingResistance, groundBlocks } from "./../../util.js";
...
const command = {
    ...
    execute(player) {
        ...
        if (illegalGroundBlocks.includes(typeOfBlock.id)) typeOfBlock = MinecraftBlockTypes.dirt;
        ...
        delayedFunc(player, (removeDirtBlock) => {
            ...
            entities.forEach(entity => {
                ...
                const damageDealt = getScore('offTier', player) * 2 + 2;
